...
if (authData.user) {
 ...
 // --- FIXED WEIGHT LOGIC ---
  ...
  // The Fixed Save Function (unused but keeping for compatibility)
    ...
    <Router>
      ...
      <main className="max-w-xl mx-auto p-6">
        ...
        {currentTab === 'pettalk' && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <div className="mb-6">
              <h2 className="text-2xl font-black text-[#5C544E] mb-2">PetTalk Community</h2>
              <p className="text-sm text-[#8A7560]">Share moments and connect with other pet lovers!</p>
            </div>

            {/* Post Creation Box */}
            <div className="bg-white p-6 rounded-[2.5rem] shadow-md border-2 border-[#EDE0CE] mb-6">
              <div className="flex items-start gap-3 mb-4">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#f9a57a] to-[#FF7A35] flex items-center justify-center text-white font-black">
                ...
                <div className="flex-1">
                  <textarea
                    ...
                    className="w-full p-4 bg-stone-50 rounded-2xl border-2 border-transparent focus:border-[#f9a57a] outline-none resize-none font-medium text-[#423D38]"
                    rows="3"
                  />
                  
                  {messagePhoto && (
                    <div className="mt-3 relative inline-block">
                      <img src={messagePhoto} alt="Upload preview" className="w-32 h-32 object-cover rounded-2xl" />
                      <button
                  ...
                  <div className="flex items-center gap-3 mt-4">
                    <label className="px-4 py-2 bg-stone-100 hover:bg-stone-200 text-[#8A7560] rounded-xl text-sm font-bold cursor-pointer transition-all flex items-center gap-2">
                      <Camera size={16} />
                      Photo
                      <input
                        type="file"
                    ...
                    <button
                      onClick={postMessage}
                      disabled={!newMessage.trim() && !messagePhoto}
                      className="px-6 py-2 bg-[#f9a57a] hover:bg-[#e88b5f] disabled:bg-stone-200 disabled:text-stone-400 text-white rounded-xl text-sm font-black cursor-pointer transition-all flex items-center gap-2"
                    >
                      Post
                    </button>
                  </div>
            ...
            <div className="space-y-4">
              {messages.length === 0 ? (
                <div className="text-center py-20 bg-white rounded-[3rem] border-2 border-dashed border-stone-200">
                  <Users size={64} className="mx-auto text-stone-300 mb-4" />
                  <h3 className="text-xl font-black text-stone-400 mb-2">No Messages Yet</h3>
                ...
                messages.map((message) => (
                  <motion.div
                    ...
                    initial={{ opacity: 0, y: 10 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="bg-white p-6 rounded-[2.5rem] shadow-md border-2 border-[#EDE0CE]"
                  >
                    <div className="flex items-start gap-3 mb-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {message.text && (
                          <p className="text-sm text-[#423D38] mb-3 leading-relaxed break-words">
                            {message.text}
                          </p>
                        )}
                        ...
                        <div className="flex items-center gap-4">
                          <button
                            ...
                            className="flex items-center gap-2 text-sm font-bold text-[#f9a57a] hover:text-[#e88b5f] transition-colors cursor-pointer"
                          >
                            <Heart size={16} fill={message.likes > 0 ? '#f9a57a' : 'none'} />
